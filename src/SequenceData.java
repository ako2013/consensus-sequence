...
public class SequenceData {
	...
	/**
	 * This method delete the key and value of given key.
	 * In this case is the name
	...
	/**
	 * This method return the size of dna's length
	 * by getting the first dna sequence and check its length.
